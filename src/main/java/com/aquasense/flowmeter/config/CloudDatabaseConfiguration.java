package com.aquasense.flowmeter.config;
...
@Configuration
@EnableMongoRepositories("com.aquasense.flowmeter.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.aquasense.flowmeter.config.dbmigrations");
